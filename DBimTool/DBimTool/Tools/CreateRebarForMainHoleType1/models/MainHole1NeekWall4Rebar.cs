...
{
    public class MainHole1NeekWall4Rebar
    {
        private static double _spacingMm = 200;
        private static double _extentMm = 50;
        public MainHole1NeekWall4 HostInfo { get; set; }
        ...
        public static MainHole1NeekWall4Rebar Init(RevHole1 revHole1, List<string> diameters)
        {
            try
            {
                var wall = new MainHole1NeekWall4Rebar();
                wall.HostInfo = new MainHole1NeekWall4(revHole1);
        ...
        private static List<Line> _initVerticalCenterLineRebar(MainHole1NeekWall4Rebar wall)
        {
        ...
        private static List<Line> _initHorizontalCenterLineRebar(MainHole1NeekWall4Rebar wall)
        {
            var results = new List<Line>();
            try
            {
