...
{
    public class MainHole1NeekWall1Rebar
    {
        private static double _spacingMm = 200;
        private static double _extentMm = 50;
        public MainHole1NeekWall1 HostInfo { get; set; }
        ...
        public static MainHole1NeekWall1Rebar Init(RevHole1 revHole1, List<string> diameters)
        {
            try
            {
                var wall = new MainHole1NeekWall1Rebar();
                wall.HostInfo = new MainHole1NeekWall1(revHole1);
        ...
        private static List<Line> _initVerticalCenterLineRebar(MainHole1NeekWall1Rebar wall)
        {
        ...
        private static List<Line> _initHorizontalCenterLineRebar(MainHole1NeekWall1Rebar wall)
        {
            var results = new List<Line>();
            try
            {
