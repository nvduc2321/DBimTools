...
{
    public class MainHole1NeekWall4 : MainHole1Element
    {
        public MainHole1NeekWall4(RevHole1 revHole1Info) : base(revHole1Info)
        {
            VtX = GetVtX();
            VtY = GetVtY();
            VtZ = GetVtZ();
        ...
        {
            return RevHole1Info.ChieuRongCo;
        }
        ...
        public override XYZ GetOrigin()
        {
            return RevHole1Info.Origin
                - RevHole1Info.VTX * (RevHole1Info.ChieuRongGa / 2 - RevHole1Info.ChieuDaiCo + RevHole1Info.ChieuDayTuong / 2)
                - RevHole1Info.VTZ * (RevHole1Info.ChieuCaoCo / 2)
                + RevHole1Info.VTY * (RevHole1Info.ChieuDaiGa / 2 - RevHole1Info.ChieuRongCo / 2);
        }
