...
{
    public class MainHole1NeekWall3Rebar
    {
        private static double _spacingMm = 200;
        private static double _extentMm = 50;
        public MainHole1NeekWall3 HostInfo { get; set; }
        ...
        public static MainHole1NeekWall3Rebar Init(RevHole1 revHole1, List<string> diameters)
        {
            try
            {
                var wall = new MainHole1NeekWall3Rebar();
                wall.HostInfo = new MainHole1NeekWall3(revHole1);
        ...
        private static List<Line> _initVerticalCenterLineRebar(MainHole1NeekWall3Rebar wall)
        {
        ...
        private static List<Line> _initHorizontalCenterLineRebar(MainHole1NeekWall3Rebar wall)
        {
            var results = new List<Line>();
            try
            {
