...
{
    public class MainHole1Wall2Rebar
    {
        public MainHole1Wall2 HostInfo { get; set; }
        ...
        public static MainHole1Wall2Rebar Init(RevHole1 revHole1, List<string> diameters)
        {
            try
            {
                var wall = new MainHole1Wall2Rebar();
                wall.HostInfo = new MainHole1Wall2(revHole1);
        ...
        private static void _generateRebarVerticalNear(MainHole1Wall2Rebar wall)
        {
        ...
        private static void _generateRebarVerticalFar(MainHole1Wall2Rebar wall)
        {
            var result = new List<RevRebar>();
            try
            {
        ...
        private static void _generateRebarHorizontalNear(MainHole1Wall2Rebar wall)
        {
            var result = new List<RevRebar>();
            try
            {
        ...
        private static void _generateRebarHorizontalFar(MainHole1Wall2Rebar wall)
        {
            var result = new List<RevRebar>();
            try
            {
        ...
        private static List<Line> _initVerticalCenterLineRebar(MainHole1Wall2Rebar wall)
        {
        ...
        private static List<Line> _initHorizontalCenterLineRebar(MainHole1Wall2Rebar wall)
        {
            var result = new List<Line>();
            try
            {
